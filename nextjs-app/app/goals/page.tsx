...
import { Target, Plus, TrendingUp, Calendar, DollarSign, Trash2, Edit, Wallet } from 'lucide-react';
...
export default function GoalsPage() {
    ...
    const handleViewGoal = async (goalId: string) => {
        ...
        try {
            const [goal, plan, progress] = await Promise.all([
                goalsAPI.getGoal(currentUserId, goalId),
                goalsAPI.getGoalPlan(currentUserId, goalId).catch(() => null),
                goalsAPI.getGoalProgress(currentUserId, goalId).catch(() => null),
            ]);
    ...
    const handleDeleteGoal = async (goalId: string) => {
        ...
        try {
            await goalsAPI.deleteGoal(goalId, currentUserId);
            toast({
                title: 'Success',
                    ...
                    <Card>
                        <CardContent className="py-12 text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Connect your wallet to manage goals
                            </p>
